...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Логи движения", path: "/stock/logs", pro: false},
    ],
  },
  {
    icon: <SuppliesIcon />,
...
const othersItems: NavItem[] = [
  {
    ...
    name: "Аутентификация",
    subItems: [
      { name: "Войти", path: "/signin", pro: false },
      { name: "Зарегистрироваться", path: "/signup", pro: false },
    ],
  },
];
                      ...
                      <span className="flex items-center gap-1 ml-auto">
                        {subItem.comingSoon && (
                          <span
                            ...
                            } menu-dropdown-badge bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400`}
                          >
                            скоро
                          </span>
                        )}
                          ...
                          <span
                            className={`ml-auto ${
                              isActive(subItem.path)
                                ? "menu-dropdown-badge-active"
                                : "menu-dropdown-badge-inactive"
                            } menu-dropdown-badge bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400`}
                          >
                            new
                          </span>
                        )}
